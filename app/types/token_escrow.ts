 ...
 * IDL can be found at `target/idl/token_escrow.json`.
 */
export type TokenEscrow = {
  "address": "BtDRSPLuXPy9zn6yfE5huNYbGq1rMqxKF5Ac5s189bUk",
  "metadata": {
    "name": "tokenEscrow",
    "version": "0.1.0",
    "spec": "0.1.0",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "feeVault",
          "writable": true,
          "address": "frae7AtwagcebTnNNFaobGH2haFUGNpFniKELbuBi2z"
        },
        {
          "name": "feeVaultA",
          "writable": true,
